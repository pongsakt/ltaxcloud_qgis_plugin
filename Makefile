...
SOURCES = \
	__init__.py \
	LTaxCloud.py LTaxCloud_dockwidget.py

PLUGINNAME = LTaxCloud

PY_FILES = \
	__init__.py \
	LTaxCloud.py LTaxCloud_dockwidget.py

UI_FILES = LTaxCloud_dockwidget_base.ui
...
QGISDIR=C:\Users\pongs\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
